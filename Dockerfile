...
RUN sudo mkdir --parents --mode 755 /opt/stanford/cs143 && \
  sudo wget --recursive --no-parent --no-host-directories --cut-dirs 3 --directory-prefix /opt/stanford/cs143 \
    --reject "index.html*" 'https://theory.stanford.edu/~aiken/software/cooldist/' 'https://theory.stanford.edu/~aiken/software/cooldist/bin/.i686/' && \
  sudo make --directory /opt/stanford/cs143 install COOL_DIR="/opt/stanford/cs143" ARCH="echo i686" && \
